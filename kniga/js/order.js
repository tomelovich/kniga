...
function addCart () {
  for (var id in cart) {
    let cartUser = JSON.stringify(cart);
    $.post (
      "/admin/core.php",
        {
          "action" : "addCart",
        ...
        function(data) {
          console.log("НА СЕРВЕР УШЛО "+JSON.stringify(cart));
        })
  }          
}
...
$(document).ready(function () {
  ...
  loadCart();
  let token = "6ddf0fad2849dee12456fc362586aa8133f01042";
  $("#address").suggestions({
    token: token,
